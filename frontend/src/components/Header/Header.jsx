...
export default function Header({ onCollectionClick, onCartClick }) {
  ...
  return (
    <header className={`site-header${hasSaleOffer ? ' site-header--has-offer' : ''}${isScrolled ? ' is-scrolled' : ''}`}>
      ...
      <button className="cart-button" type="button" aria-label="Open shopping cart" onClick={onCartClick}>
